package com.hiraeth.registry.client;

import com.alibaba.fastjson.JSON;
import com.hiraeth.registry.client.config.Configuration;
import com.hiraeth.registry.client.network.*;
...
import org.hiraeth.registry.common.domain.request.FetchMetaDataRequest;
import org.hiraeth.registry.common.domain.request.ServiceChangedRequest;
import org.hiraeth.registry.common.domain.request.RegisterServiceRequest;
...
import static org.hiraeth.registry.common.constant.Constant.REQUEST_WAIT_SLEEP_INTERVAL;
...
public class ServiceInstance {
    ...
    private Map<String, List<SlotRange>> slotsMap;
    ...
    private String locateServerNodeBySlot(int slot) {
        for (String nodeId : slotsMap.keySet()) {
            List<SlotRange> slotRanges = slotsMap.get(nodeId);
